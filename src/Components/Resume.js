...
import '../App.css'
import test2 from './img/team2.jpg'
import test1 from './img/team1.jpg'
import test3 from './img/team3.jpg'
    ...
    render() {
        return (
            <div className="container">
                <div className="section-vcardbody section-home" id="page-resume">
                    {/* SECTION: Education */}
                    ...
                    <div className="testimonials">
                        ...
                        <div className="testimonial-slides" id="testimonial-carousel">
                            {/* item */}
                            <OwlCarousel className="owl-theme" {...hias}>
